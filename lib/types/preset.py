...
class Preset:
	def __init__(self) -> None:
		...
		self.maskThresh:int = 230 # 50-254 // try
		self.maskMorph:tuple[int,int] = (5,5) # 3-13 // try
		self.maskContourFilterMaxArea:float = .004 # 0.002-0.01 // maybe try if not too much

		self.conjectionBlur:int = 3 # 3-13 // try
		self.conjectionThresh:int = 128 # 50-254 // try
		...
		self.conjectionClusterEps:float = 0.043 # uses img width // try
